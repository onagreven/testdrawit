...
// deze functie is voor popupvenster met informatie
...
function initCameraUI() {
  ...
  drawGuidesButton = document.getElementById('drawGuidesButton');
 ...
 drawGuidesButton.addEventListener('click', function () {
    takeSnapshotUI();
    takeSnapshot();
  });
...
var mySelWidth = 2;
var mySelBoxColor = 'black'; //Kleur van handles New for selection boxes
var mySelBoxSize = 20;
var ghostcanvas;
...
function init2() {
  ...
  document.getElementById('takePhotoButton').onclick = function() {
   addRect(20, 550, 60, 65, 'rgba(49,70,148,0.7)');
}; // tekent rechthoek wanneer er op de middelste knop wordt gedrukt


document.getElementById('drawGuidesButton').onclick = function(){
addRect(0, 15, 1150, 5, 'rgba(0,0,0)');
    addRect(15, 0, 5, 759, 'rgba(0,0,0)');  

//addArc(20,550,60,65, 'rgba(255,255,255,0.7)')

}; // tekent cirkel wanneer er op full screen button gedrukt wordt 


 //document.getElementById('switchCameraButton').onclick = function() {
...
//}; 
  ...
  //addRect(20, 550, 60, 65, 'rgba(150,150,250,0.7)');
  //  addRect(20, 550, 60, 65, 'rgba(150,150,250,0.7)');
   //   addRect(20, 550, 60, 65, 'rgba(150,150,250,0.7)');
    //    addRect(20, 550, 60, 65, 'rgba(150,150,250,0.7)');
    //      addRect(20, 550, 60, 65, 'rgba(150,150,250,0.7)');
